...
\begin{itemize}
  ...
  \item \textbf{Broadening Mechanisms:}
  \begin{itemize}
    \item \hl{Homogeneous Broadening:} Molecules are identical at $t = 0$; the peak broadens dynamically via uniform dephasing over time.
    \item \hl{Inhomogeneous Broadening:} Molecules experience varying static local environments at $t = 0$, generating an initial distribution of different frequencies.
  \end{itemize}
